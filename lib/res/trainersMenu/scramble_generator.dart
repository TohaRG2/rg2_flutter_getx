...
const scramble_gen_help = """
  ...
  <p><b>Без переплавки буфера ребер</b> и <b>Без переплавки буфера углов</b> - как уже было сказано
   ...
   затруднения, да тут еще и эта переплавка с поиском пустой корзины.</p>
  ...
  не установлена, то вы увидите длину (количество букв) в решении и есть ли в нем перплавки буферов. 
  Тем самым вы сможете подобрать соответствующий по сложности скрамбл не видя его решения.
  </p>
  ...
  <p>Зайдя в настройки генератора скрамблов,
  вы можете выбрать начальное положение кубика, т.е. то, как изначально располагаются его стороны.
  А нажав на любую букву, можно поменять ее. Также можете выбрать одну из двух предустановленных азбук
  (мою или Максима) или придумать/сохранить/настроить свою.Например, если вы запоминаете кубик для 
  положения желтый цвет сверху, то сдвиньте при помощи стрелочек цвета так, чтобы буквы АБВГ у вас 
  оказались на желтой стороне.</p> 
  
  <p>Надеюсь, что интерфейс настройки азбуки у вас не вызовет затруднений. И заметьте, что заданная 
  тут азбука будет использована не только в генераторе скрамблов, но и в игре \"Тренировка азбуки\" и ее настройках.</p>
""";