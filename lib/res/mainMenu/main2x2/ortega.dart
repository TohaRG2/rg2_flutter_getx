...
///==================================================
    ...
    static const ortega1_descr = """
        ...
        И еще очень важное умение, которое необходимо освоить после сборки первой стороны - научиться
        ...
        <p>Небольшой совет, как легко определить ситуацию, по любым двум сторонам:</p>

        <p>1. Если обе наклейки угла противоположны соседним наклейкам,</p>
